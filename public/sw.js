const CACHE='live-chat-shell-v14';
const SHELL=['/','/style.css?v=chat-actions-profile-1','/mobile-fix.css?v=chat-actions-profile-1','/features.css?v=chat-actions-profile-1','/whatsapp.css?v=android-call-5','/android-stability.css?v=stable-2','/experience.css?v=experience-4','/app.js?v=stable-5','/platform-fixes.js?v=stable-1','/manifest.webmanifest','/favicon.svg','/icon-192.png','/icon-512.png'];
