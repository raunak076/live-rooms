const CACHE='live-chat-shell-v8';
const SHELL=['/','/style.css?v=chat-actions-profile-1','/mobile-fix.css?v=chat-actions-profile-1','/features.css?v=chat-actions-profile-1','/whatsapp.css?v=premium-ui-4','/app.js?v=premium-ui-4','/platform-fixes.js?v=mobile-alerts-3','/manifest.webmanifest','/favicon.svg','/icon-192.png','/icon-512.png'];
