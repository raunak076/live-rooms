...
export function createChat({generate=askGemini,dbPath='data/chat.db',pushNotification,voiceClone,voiceReviewKey=process.env.VOICE_REVIEW_KEY}={}) {
  ...
  app.get('/api/health',(_,res)=>res.json({ok:true,aiConfigured:Boolean(process.env.GEMINI_API_KEY),voiceCloneConfigured:Boolean(voiceClone||process.env.VOICE_CLONE_ENDPOINT),voiceReviewConfigured:Boolean(voiceReviewKey)}));
